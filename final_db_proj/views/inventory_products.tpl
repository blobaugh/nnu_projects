...
<center>
        <table width="80%" border="0" cellpadding="4" cellspacing="0">
                <tr class="noBorders">
                        <td colspan="5"><a href="{$http_link}product"><img src="{$http_images}icons/database_add.png" alt="New Product" title="New Product" width="16" height="16" class="icon" />New Product</a></td>
                </tr>
                <tr>
