 ...
 */
$DevProject = "budget/"; // For use by the developer

// Mysql Connection Info
$Reg->Set('db_user', 'root');
$Reg->Set('db_password', '');
$Reg->Set('db_location', 'internal-db.s21288.gridserver.com');
$Reg->Set('db_name', 'creds');

$Reg->Set('tplTitle', 'PHP Budget');

// Paths
$Reg->Set('doc_root', $_SERVER['DOC_ROOT']); // Default is usually correct. Only change if your site is in a subdirectory

// Default Controller
$Reg->Set('default_controller', 'view_statements');
