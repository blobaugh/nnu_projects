...
function __autoload($class_name) {
        ...
        find_file(ucfirst($class_name) . '.class.php', find_doc_root() . 'app/lib');
        if(!class_exists($class_name)) {
	        $location = find_file(ucfirst($class_name) . '.class.php', find_doc_root() . 'core/lib');
	}
 ...
 * @return String
 **/
function find_file($file, $dir) {// echo "<br>$dir Looking for: $file";
//echo "Looking for $file in $dir<br>";
