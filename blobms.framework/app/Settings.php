...
/*
 * Site mode affects the displaying of errors and other
 * debugging information.
 *
 * Modes:
 *      debug - Show all errors and debug messages
 *      production - do not show errors
 */
 $Reg->Set('site_mode', 'production');
...
// Location of module folder in file system
$Reg->Set('path_modules', $Reg->Get('doc_root') . 'modules/');

/* URI Paths
 *
 * These are provided as full pathsto help ease the job of template creators
 */
